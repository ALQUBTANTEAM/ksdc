...
download('https://raw.githubusercontent.com/ALQUBTANTEAM/ksdc/master/KOIA.lua','KOIA.lua')
...
Redis:sadd(TheKOIA.."KOIA:TheBasics:Group"..msg_chat_id,msg.sender.user_id) 
...
if text == (Redis:get(TheKOIA.."KOIA:Name:Bot") or "ميلانو") then
local NamesBot = (Redis:get(TheKOIA.."KOIA:Name:Bot") or "ميلانو")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheKOIA.."KOIA:Name:Bot") or "ميلانو")..
